...
merchant_transaction_entity_response_data_inner_instance = MerchantTransactionEntityResponseDataInner.from_json(json)
# print the JSON string representation of the object
print(MerchantTransactionEntityResponseDataInner.to_json())

# convert the object into a dict
merchant_transaction_entity_response_data_inner_dict = merchant_transaction_entity_response_data_inner_instance.to_dict()
# create an instance of MerchantTransactionEntityResponseDataInner from a dict
merchant_transaction_entity_response_data_inner_from_dict = MerchantTransactionEntityResponseDataInner.from_dict(merchant_transaction_entity_response_data_inner_dict)
```
