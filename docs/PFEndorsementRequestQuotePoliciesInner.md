...
**policy_number** | **str** | This denotes the policy number. | [optional] 
...
**policy_fee** | [**List[PFEndorsementRequestQuotePoliciesInnerPolicyFeeInner]**](PFEndorsementRequestQuotePoliciesInnerPolicyFeeInner.md) |  | [optional] 
