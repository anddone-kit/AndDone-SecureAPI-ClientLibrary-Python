...
**program_id** | **int** | This denotes the program ID. | [optional] 
**broker_fee** | **int** | This denotes the broker fees. | [optional] 
...
**quote_expiration_days** | **int** | This denotes the number of days to expire. | [optional] 
