...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | Payment Intent Id

    try:
        # This API expires the payment Intent or link.
        api_response = api_instance.secure_paymentintents_expirations_post(x_api_key, x_app_key, x_version, origin, id)
