...
class TestTokenLinkResponseDataInner(unittest.TestCase):
    """TokenLinkResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenLinkResponseDataInner:
        """Test TokenLinkResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenLinkResponseDataInner`
        """
        model = TokenLinkResponseDataInner()
        if include_optional:
            return TokenLinkResponseDataInner(
                merchant_id = '',
                token_link_id = '',
                title = '',
                url = '',
    ...
    def testTokenLinkResponseDataInner(self):
        """Test TokenLinkResponseDataInner"""
