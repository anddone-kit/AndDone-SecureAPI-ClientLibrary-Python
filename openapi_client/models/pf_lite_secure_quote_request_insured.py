...
class PFLiteSecureQuoteRequestInsured(BaseModel):
    ...
    named_insured: Optional[StrictStr] = Field(default=None, alias="namedInsured")
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "namedInsured", "mobilePhoneNumber", "emailAddress", "isCancellationWarningViaTextEnabled", "faxNumber", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "namedInsured": obj.get("namedInsured"),
