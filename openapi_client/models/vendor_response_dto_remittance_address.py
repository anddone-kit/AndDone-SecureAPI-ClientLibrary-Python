...
class VendorResponseDTORemittanceAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["vendorId", "attention", "addressLine1", "addressLine2", "city", "state", "country", "postalCode", "addressType", "addressSource", "verificationStatus"]
