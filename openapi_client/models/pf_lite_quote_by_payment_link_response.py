...
class PFLiteQuoteByPaymentLinkResponse(BaseModel):
    ...
    policies: Optional[List[PFLiteQuoteByPaymentLinkResponsePoliciesInner]] = Field(default=None, description="List of policies associated with the quote")
    ...
    broker_fee: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="brokerFee")
    ...
    def quote_status_validate_enum(cls, value):
        ...
        if value not in set(['None', 'Created', 'ESigned', 'SentForBooking', 'Booked', 'AccountCreated', 'Expired', 'EndorsementCreated', 'EndorsementESigned', 'EndorsementCompleted', 'Drafted', 'PaidInFull']):
            raise ValueError("must be one of enum values ('None', 'Created', 'ESigned', 'SentForBooking', 'Booked', 'AccountCreated', 'Expired', 'EndorsementCreated', 'EndorsementESigned', 'EndorsementCompleted', 'Drafted', 'PaidInFull')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policies": [PFLiteQuoteByPaymentLinkResponsePoliciesInner.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
