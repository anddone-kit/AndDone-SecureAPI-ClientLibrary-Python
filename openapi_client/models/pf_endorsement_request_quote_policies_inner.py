...
class PFEndorsementRequestQuotePoliciesInner(BaseModel):
    ...
    policy_number: Optional[StrictStr] = Field(default=None, description="This denotes the policy number.", alias="policyNumber")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policyFee": [PFEndorsementRequestQuotePoliciesInnerPolicyFeeInner.from_dict(_item) for _item in obj["policyFee"]] if obj.get("policyFee") is not None else None,
