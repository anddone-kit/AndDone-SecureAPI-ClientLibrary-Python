...
class PaymentLinkResponseReferenceDataListInner(BaseModel):
    ...
    def reference_type_validate_enum(cls, value):
        ...
        if value not in set(['QuoteId', 'AccountNumber', 'PolicyNumber', 'InvoiceNumber', 'Other']):
            raise ValueError("must be one of enum values ('QuoteId', 'AccountNumber', 'PolicyNumber', 'InvoiceNumber', 'Other')")
        return value
