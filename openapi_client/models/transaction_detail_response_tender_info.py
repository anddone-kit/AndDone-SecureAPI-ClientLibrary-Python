...
class TransactionDetailResponseTenderInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bankName", "routingNumber", "accountType", "checkType", "checkNumber", "accountCategory", "accountHolderName", "nameOnCheck", "cardHolderName", "cardType", "maskCardNumber", "binNumber", "cardExpiry", "captureAmount", "amount", "convenienceAmount", "adjustmentPercentValue", "adjustmentFixedValue", "adjustmentAmount", "adjustmentDisplayName", "adjustmentDescriptorMessage", "paymentAdjustmentType", "preAuthCode", "maskAccount", "accountToken", "accountTokenMessage", "createAccountToken", "commissionType", "commissionValue", "commissionFixedValue", "currency", "fullAccountNumber"]
