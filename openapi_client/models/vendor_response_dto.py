...
class VendorResponseDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "paymentBasedId", "legalEntityType", "merchantId", "vendorName", "vendorAliasName", "vendorDbName", "paymentMethodType", "notificationType", "vendorNotes", "phoneNumber", "isMobileNumber", "email", "url", "vendorStatus", "useSameAsPhysicalAddress", "remittanceAddress", "physicalAddress", "verificationResults", "createdBy", "modifiedBy", "createdOn", "modifiedOn", "approvedDate", "template"]
