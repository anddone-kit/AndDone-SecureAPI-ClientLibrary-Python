...
class SecureUpdatePaymentLinkRequestSettingsIntent(BaseModel):
    """
    ...
    def payment_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['ACH', 'CreditCard', 'DebitCard']):
                raise ValueError("each list item must be one of ('ACH', 'CreditCard', 'DebitCard')")
        return value
