...
class PaymentLinkResponseCustomersInnerAccountsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "channelType", "cardNumber", "cardType", "accountToken", "accountNumber", "bankName", "isCheckingAccount", "isExpired", "createdOn", "createdBy", "modifiedOn", "modifiedBy"]
