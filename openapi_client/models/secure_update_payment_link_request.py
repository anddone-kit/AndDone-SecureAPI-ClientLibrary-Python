...
class SecureUpdatePaymentLinkRequest(BaseModel):
    """
    ...
    settings: Optional[SecureUpdatePaymentLinkRequestSettings] = None
    ...
    __properties: ClassVar[List[str]] = ["merchantId", "title", "paymentDescription", "customers", "invoiceNumber", "expireBy", "expireOn", "lineItems", "shortDescription", "responseType", "callbackParameters", "paymentLinkType", "saveForFuture", "splits", "quoteKey", "accountNumber", "referenceType", "referenceNumber", "referenceKey", "referenceDataList", "platformSettlementStatus", "isPayInFull", "isPremiumFinancier", "pfr", "pfType", "amount", "enablePremiumFinance", "expireIn", "expireInUnit", "settings", "suppressTechnologyFee", "overrideTechnologyFee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": SecureUpdatePaymentLinkRequestSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
