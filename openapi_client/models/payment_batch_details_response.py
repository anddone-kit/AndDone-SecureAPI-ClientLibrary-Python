...
class PaymentBatchDetailsResponse(BaseModel):
    ...
    refunded_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="refundedCount")
    refunded_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="refundedAmount")
    chargeback_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="chargebackCount")
