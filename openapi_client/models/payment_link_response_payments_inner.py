...
class PaymentLinkResponsePaymentsInner(BaseModel):
    """
    ...
    masked_account: Optional[StrictStr] = Field(default=None, alias="maskedAccount")
    created_on: Optional[StrictStr] = Field(default=None, alias="createdOn")
    __properties: ClassVar[List[str]] = ["transactionId", "transactionStatus", "amount", "authCode", "customerId", "accountToken", "channelType", "maskedAccount", "createdOn"]
    ...
    def channel_type_validate_enum(cls, value):
        ...
        if value not in set(['ACH', 'CreditCard', 'DebitCard', 'RTP']):
            raise ValueError("must be one of enum values ('ACH', 'CreditCard', 'DebitCard', 'RTP')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maskedAccount": obj.get("maskedAccount"),
