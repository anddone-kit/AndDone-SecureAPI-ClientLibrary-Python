...
class SecureTransactionDetailDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["transactionId", "traceNumber", "transactionCode", "transactionOrigin", "refundOrigin", "billingContact", "shippingContact", "referenceTransactionId", "transactionDate", "merchantId", "ipAddress", "operationType", "channelType", "processMethod", "processorName", "isDebit", "tenderInfo", "referenceCustomerId", "invoiceNo", "referenceNo", "remarks", "recurringType", "recurringId", "installmentNumber", "installmentCount", "allowDuplicates", "verificationEnabled", "sentSuccessNotification", "sentFailedNotification", "trainingMode", "terminalId", "isOffline", "transactionStatus", "previousTransactionStatus", "transactionResult", "level", "partnerId", "orderId", "invoiceId", "paymentLinkId", "additionalFields", "settlementDate", "issuer", "paymentReference", "refundReference"]
