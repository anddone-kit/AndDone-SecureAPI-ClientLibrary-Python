...
class PFQuoteEsignRequest(BaseModel):
    ...
    PFQuoteEsignRequest
    """ # noqa: E501
    merchant_token: Optional[StrictStr] = Field(default=None, description="This denotes the merchant token.", alias="merchantToken")
    ...
    ip_address: Optional[StrictStr] = Field(default=None, description="This denotes the IP address of the client.", alias="ipAddress")
