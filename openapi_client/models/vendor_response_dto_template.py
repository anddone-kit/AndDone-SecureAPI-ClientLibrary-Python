...
class VendorResponseDTOTemplate(BaseModel):
    """
    VendorResponseDTOTemplate
    """ # noqa: E501
    id: Optional[StrictStr] = None
    template_name: Optional[StrictStr] = Field(default=None, alias="templateName")
    template_json: Optional[StrictStr] = Field(default=None, alias="templateJson")
    is_system_default: Optional[StrictBool] = Field(default=None, alias="isSystemDefault")
    __properties: ClassVar[List[str]] = ["id", "templateName", "templateJson", "isSystemDefault"]
