...
class PaymentLinkResponseLineItemsInner(BaseModel):
    """
    PaymentLinkResponseLineItemsInner
    """ # noqa: E501
    line_item_type: Optional[StrictStr] = Field(default=None, alias="lineItemType")
    ...
    def line_item_type_validate_enum(cls, value):
        ...
        if value not in set(['External', 'Product', 'Service']):
            raise ValueError("must be one of enum values ('External', 'Product', 'Service')")
        return value
