...
class SecureAutopayEnrollmentApi:
    ...
    @validate_call
    def secure_autopayenrollment_post(
        self,
        ...
        auto_pay_enrollment_request: Annotated[AutoPayEnrollmentRequest, Field(description="Autopay Enrollment Detail")],
        ...
        :type origin: str
        :param auto_pay_enrollment_request: Autopay Enrollment Detail (required)
        :type auto_pay_enrollment_request: AutoPayEnrollmentRequest
        ...
        _param = self._secure_autopayenrollment_post_serialize(
            x_api_key=x_api_key,
            x_app_key=x_app_key,
            x_version=x_version,
            origin=origin,
            auto_pay_enrollment_request=auto_pay_enrollment_request,
    ...
    @validate_call
    def secure_autopayenrollment_post_with_http_info(
        self,
        x_api_key: Annotated[StrictStr, Field(description="an authorization header")],
        x_app_key: Annotated[StrictStr, Field(description="an authorization header")],
        x_version: Annotated[StrictStr, Field(description="x-version")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AutoPayEnrollmentResponse]:
        """This API is used for Autopay Enrollment.
    ...
    @validate_call
    def secure_autopayenrollment_post_without_preload_content(
        self,
        x_api_key: Annotated[StrictStr, Field(description="an authorization header")],
        x_app_key: Annotated[StrictStr, Field(description="an authorization header")],
        x_version: Annotated[StrictStr, Field(description="x-version")],
    ...
    def _secure_autopayenrollment_post_serialize(
        self,
        x_api_key,
        x_app_key,
        x_version,
        origin,
        auto_pay_enrollment_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if auto_pay_enrollment_request is not None:
            _body_params = auto_pay_enrollment_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/secure/autopayenrollment',
